...
/*
	Guns Vs Knives
	Objective: 	Score points for your team by eliminating players on the opposing team. Allies are equiped with guns only, where axis are equiped with melee weapons only
...
main()
{
	...
	maps\mp\gametypes\_globallogic::registerTimeLimitDvar( "gvk", 10, 0, 1440 );
	maps\mp\gametypes\_globallogic::registerScoreLimitDvar( "gvk", 500, 0, 5000 );
	maps\mp\gametypes\_globallogic::registerRoundLimitDvar( "gvk", 1, 0, 10 );
	maps\mp\gametypes\_globallogic::registerNumLivesDvar( "gvk", 0, 0, 10 );
