...
//	registerTweakable( "player", 		"respawndelay", 		"scr_player_respawndelay", 			0 ); //*
	...
	registerTweakable( "hardpoint", "allowthrowingknives", 	"scr_hardpoint_allowthrowingknives", 1 );
	registerTweakable( "hardpoint", "allowuav", 		"scr_hardpoint_allowuav", 1 );
	registerTweakable( "hardpoint", "allowspeed", 		"scr_hardpoint_allowspeed", 1 );
	registerTweakable( "hardpoint", "allowassassin", 	"scr_hardpoint_allowassassin", 1 );
