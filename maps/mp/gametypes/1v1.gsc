...
/*
	Deathmatch
	Objective: 	Score points by eliminating the other player
	Map ends:	When one player reaches the score limit, or time limit is reached
	Respawning:	No wait / Away from opponent

	Level requirements
	------------------
		Spawnpoints:
			classname		mp_dm_spawn
			Both players spawn from these. The spawnpoint chosen is dependent on the current locations of enemies at the time of spawn.
...
main()
{
	...
	maps\mp\gametypes\_globallogic::registerTimeLimitDvar( "1v1", 10, 0, 1440 );
	maps\mp\gametypes\_globallogic::registerScoreLimitDvar( "1v1", 1000, 0, 5000 );
	maps\mp\gametypes\_globallogic::registerRoundLimitDvar( "1v1", 1, 0, 10 );
	maps\mp\gametypes\_globallogic::registerNumLivesDvar( "1v1", 0, 0, 10 );
