...
modinfo()
{
	...
	if(getDvarInt("scr_scrimmode"))
	{
		level.modinfo.x = 400;
		level.modinfo.y = 10;
		level.modinfo setText("^2M*A*S*H KNIVES ^11.6-D2 ^3SCRIM MODE");
	}
		...
		level.modinfo.x = 400;
		level.modinfo.y = 10;
		level.modinfo setText("^2M*A*S*H KNIVES ^11.6-D2 ^31v1 Mode");
	}
	...
	else
	{
		level.modinfo.x = 370;
		level.modinfo.y = 10;
		level.modinfo setText("^2M*A*S*H KNIVES ^11.6-D2");
	}
}
