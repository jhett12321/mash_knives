...
onPrecacheGameType()
{
	 ...
	 precacheString( &"MASH_ENEMY_FLAG_CAPTURED_BY" );
	 precacheString( &"MASH_ENEMY_FLAG_DROPPED_BY" );
	 precacheString( &"MASH_ENEMY_FLAG_RETURNED" );
	 precacheString( &"MASH_ENEMY_FLAG_TAKEN" );
	 precacheString( &"MASH_ENEMY_FLAG_TAKEN_BY" );
	 precacheString( &"MASH_ENEMY_FLAG_DROPPED" );
	 precacheString( &"MASH_ENEMY_FLAG_RETURNED_BY" );
	 precacheString( &"MASH_FLAG_CAPTURED_BY" );
	 precacheString( &"MASH_FLAG_RETURNED" );
	 precacheString( &"MASH_FLAG_RETURNED_BY" );
	 precacheString( &"MASH_FLAG_TAKEN_BY" );
	 precacheString( &"MASH_FLAG_DROPPED" );
	 precacheString( &"MASH_FLAG_DROPPED_BY" );
}
