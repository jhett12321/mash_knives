	...
	)
{
	...
	else if((isSubStr(sWeapon, "cobra") || isSubStr(sWeapon, "gunship")))
	{
		camtime = 3.0;
		self SetClientDvar("cg_heliKillCamDist", "1000");
	}
	else if(!respawn)
	{
		camtime = 5.0;
		self SetClientDvar("cg_airstrikeCamDist", "200");
	}
	else
	{
		camtime = 2.5;
	...
	if(isDefined(killCamSpawnTime))
		camtime = (getTime() - killCamSpawnTime) / 1000;
